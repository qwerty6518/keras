...
class _BaseIOU(Metric):
  ...
  def __init__(self, num_classes, name=None, dtype=None):
    super(_BaseIOU, self).__init__(name=name, dtype=dtype)
...
class IoU(_BaseIOU):
  """Computes the Intersection-Over-Union metric for a specific class.
